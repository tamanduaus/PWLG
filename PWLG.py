...
def main():
    terminal_menu = TerminalMenu(
        ["Name", "Partner", "Kids", "Pet", "Company", "School"],
        multi_select=True,
...
# List with two elements:
    if len(menu_entry_indices) == 2:
        if menu_entry_indices[1] == 1:
            wife = input("> Partner's name: ")
            wifen = input("> Partner's nickname: ")
            wifeb = input("> Partner's date of birth (DDMMYYYY): ")
            
        if menu_entry_indices[1] == 2:        
            kids = input("How many kids would you like to include (Maximum 4)? ")
            ...
            if kids == "2":
                kid = input("> Kid's name: ")
                kidn = input("> Kid's nickname: ")
                kidb = input("> Kid's date of birth (DDMMYYYY Ex:04111985): ")

                kid1 = input("> Second Kid's name: ")
                kid1n = input("> Second Kid's nickname: ")
                kid1b = input("> Second Kid's date of birth (DDMMYYYY Ex:04111985): ")
            ...
            if kids == "3":
                ...
                kid2b = input("> Third Kid's date of birth (DDMMYYYY Ex:04111985): ")
            ...
            if kids == "4":
                ...
                kid3b = input("> Fourth Kid's date of birth (DDMMYYYY Ex:04111985): ")

        if menu_entry_indices[1] == 3:
            pet = input("> Pet's name: ")

        if menu_entry_indices[1] == 4:
            company = input("> Company name: ")
            companyd = input("> Year joined: ")

        if menu_entry_indices[1] == 5:
            school = input("> School/University: ")
            schoold = input("> Year of entry: ")
            schoold1 = input("> Year of graduation: ")
        
# with three elements: 
    if len(menu_entry_indices) == 3:
        if menu_entry_indices[1] == 1 or menu_entry_indices[2] == 2:
            wife = input("> Partner's name: ")
            wifen = input("> Partner's nickname: ")
            wifeb = input("> Partner's date of birth (DDMMYYYY): ")

        if menu_entry_indices[1] == 2 or menu_entry_indices[2] == 2:
            kids = input("> How many kids would you like to include (Maximum 4)? ")
        ...
        if menu_entry_indices[1] == 3 or menu_entry_indices[2] == 3:
            pet = input("> Pet's name: ")

        if menu_entry_indices[1] == 4 or menu_entry_indices[2] == 4:
            company = input("> Company name: ")
            companyd = input("> Year joined: ")

        if menu_entry_indices[1] == 5 or menu_entry_indices[2] == 5:
            school = input("> School/University: ")
            schoold = input("> Year of entry: ")
            schoold1 = input("> Year of graduation: ")
...
# with four elements:
    ...
    if len(menu_entry_indices) == 4:
        ...
        if menu_entry_indices[1] == 3 or menu_entry_indices[2] == 3 or menu_entry_indices[3] == 3:
            pet = input("> Pet's name: ")

        if menu_entry_indices[1] == 4  or menu_entry_indices[2] == 4 or menu_entry_indices[3] == 4:
            company = input("> Company name: ")
            companyd = input("> Year joined: ")

        if menu_entry_indices[1] == 5 or menu_entry_indices[2] == 5 or menu_entry_indices[3] == 5:
            school = input("> School/University: ")
            schoold = input("> Year of entry: ")
            schoold1 = input("> Year of graduation: ")
...
# witew 5 elements:
    ...
    if len(menu_entry_indices) == 5:
        ...
        if menu_entry_indices[1] == 4  or menu_entry_indices[2] == 4 or menu_entry_indices[3] == 4 or menu_entry_indices[4] == 4:
            company = input("> Company name: ")
            companyd = input("> Year joined: ")

        if menu_entry_indices[1] == 5 or menu_entry_indices[2] == 5 or menu_entry_indices[3] == 5 or menu_entry_indices[4] == 5:
            school = input("> School/University: ")
            schoold = input("> Year of entry: ")
            schoold1 = input("> Year of graduation: ")
